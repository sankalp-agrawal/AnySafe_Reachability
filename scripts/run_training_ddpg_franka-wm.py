...
train_envs = DummyVectorEnv(
    [
        lambda: gymnasium.make(args.task_lcrl, params=[wm, datasets, config])
...
log_path = os.path.join(
    args.logdir + "/lcrl",
    args.task_lcrl,
    "wm_actor_activation_{}_critic_activation_{}_game_gd_steps_{}_tau_{}_training_num_{}_buffer_size_{}_c_net_{}_{}_a1_{}_{}_a2_{}_{}_gamma_{}".format(
