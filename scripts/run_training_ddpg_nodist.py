...
def get_args():
    ...
    parser.add_argument(
        "--task", type=str, default="dubins4d-v0"
    ...
    )  # e.g., log/ra_droneracing_Game-v6/epoch_id_10/policy.pth
    parser.add_argument(
        "--new-expl", type=bool, default=False
    )  # e.g., log/ra_droneracing_Game-v6/epoch_id_10/policy.pth
...
log_path = os.path.join(
    args.logdir,
    args.task,
    "ddpg_reach_avoid_actor_activation_{}_critic_activation_{}_game_gd_steps_{}_tau_{}_training_num_{}_buffer_size_{}_c_net_{}_{}_a1_{}_{}_gamma_{}".format(
